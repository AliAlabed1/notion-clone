...
const FollowPointer = ({info,x,y}:{info:{name:string,emmail:string,avatar:string},x:number,y:number}) => {
    const color = stringToColor(info.emmail || '1')
    return (
        <motion.div 
